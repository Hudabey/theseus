...
class Keys:
    ...
    class KDA:
        ...
        GATE_LOWER_BOUND = "{arch}.kda.gate_lower_bound"    # Kimi K3

    class AttnRes:                                          # Kimi K3
        BLOCK_SIZE = "{arch}.attnres.block_size"

    class SiTU:                                             # Kimi K3
        BETA        = "{arch}.situ.beta"
        LINEAR_BETA = "{arch}.situ.linear_beta"

    class LatentMoE:                                        # Kimi K3
        DIM = "{arch}.latent_moe.dim"
...
class MODEL_TENSOR(IntEnum):
    ...
    ATTN_RES_PROJ        = auto() # Kimi K3 AttnRes
    ATTN_RES_NORM        = auto() # Kimi K3 AttnRes
    FFN_RES_PROJ         = auto() # Kimi K3 AttnRes
    FFN_RES_NORM         = auto() # Kimi K3 AttnRes
    RES_PROJ             = auto() # Kimi K3 AttnRes (model-level)
    RES_NORM             = auto() # Kimi K3 AttnRes (model-level)
    FFN_LATENT_DOWN      = auto() # Kimi K3 Stable LatentMoE
    FFN_LATENT_UP        = auto() # Kimi K3 Stable LatentMoE
    FFN_LATENT_NORM      = auto() # Kimi K3 Stable LatentMoE
    TIME_MIX_W0          = auto()
    TIME_MIX_W1          = auto()
    TIME_MIX_W2          = auto()
    TIME_MIX_A0          = auto()
...
TENSOR_NAMES: dict[MODEL_TENSOR, str] = {
    ...
    MODEL_TENSOR.RES_PROJ:                  "res_proj",                       # Kimi K3
    MODEL_TENSOR.RES_NORM:                  "res_norm",                       # Kimi K3
    MODEL_TENSOR.FFN_LATENT_DOWN:           "blk.{bid}.ffn_latent_down",      # Kimi K3
    MODEL_TENSOR.FFN_LATENT_UP:             "blk.{bid}.ffn_latent_up",        # Kimi K3
    MODEL_TENSOR.FFN_LATENT_NORM:           "blk.{bid}.ffn_latent_norm",      # Kimi K3
...
MODEL_TENSORS: dict[MODEL_ARCH, list[MODEL_TENSOR]] = {
    ...
    MODEL_ARCH.KIMI_K3: [
        ...
        MODEL_TENSOR.RES_PROJ,
        MODEL_TENSOR.RES_NORM,
        MODEL_TENSOR.FFN_LATENT_DOWN,
        MODEL_TENSOR.FFN_LATENT_UP,
        MODEL_TENSOR.FFN_LATENT_NORM,
    ],
    MODEL_ARCH.TALKIE: [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT,
