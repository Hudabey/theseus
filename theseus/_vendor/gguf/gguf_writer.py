...
class GGUFWriter:
    ...
    def add_attnres_block_size(self, value: int) -> None:
    ...
    def add_latent_moe_dim(self, value: int) -> None:
        self.add_uint32(Keys.LatentMoE.DIM.format(arch=self.arch), value)
