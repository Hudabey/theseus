...
class QwenModel(TextModel):
    ...
    def token_bytes_to_string(b):
        # theseus patch: bytes_to_unicode moved between transformers versions
        # (gpt2.tokenization_gpt2 in <=4.x, convert_slow_tokenizer in 5.x)
        try:
